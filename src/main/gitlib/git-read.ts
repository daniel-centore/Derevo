...
export const getModifiedFiles = async (dir: string) => {
    ...
    > = {
        ...
        DD: { change: 'deleted', staged: false },
        AM: { change: 'modified', staged: false },
        AU: { change: 'new', staged: false },
        UD: { change: 'deleted', staged: false },
        UA: { change: 'new', staged: false },
        DU: { change: 'deleted', staged: false },
